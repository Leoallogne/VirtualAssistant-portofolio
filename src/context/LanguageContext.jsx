...
export const translations = {
  id: {
    ...
    simTabTerminal: "💻 Konsol Terminal",
    simTabDashboard: "📊 Live Dashboard",
    simStatusIdle: "STATUS: MENUNGGU INSTRUKSI",
    simStatusRunning: "STATUS: MENGEKSEKUSI TUGAS...",
    simStatusSuccess: "STATUS: SINKRON & SELESAI",
  ...
  en: {
    ...
    simTerminalTitle: "💻 Virtual Assistant Execution Terminal",
    simTabTerminal: "💻 Terminal Console",
    simTabDashboard: "📊 Live Dashboard",
    simStatusIdle: "STATUS: AWAITING INSTRUCTIONS",
    simStatusRunning: "STATUS: EXECUTING AGENT WORKLOAD...",
    simStatusSuccess: "STATUS: SYNCHRONIZED & RESOLVED",
